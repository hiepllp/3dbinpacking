...
// string function cleanString($cad) --> retorna una cadena sin acentos.
...
function sheetData($sheet) {
  ...
  while($x <= $sheet['numRows']) {
    ...
    while($y <= $sheet['numCols']) {
      $cell = isset($sheet['cells'][$x][$y]) ? '<td style="border: 1px solid black;">'.$sheet['cells'][$x][$y].'<td>' : '<td></td>';
      $re .= $cell;
      //$cell2 = strlen($cell) ? '<td>'.$cell.'</td>' : '<td style="border: 1px solid black;">'.$cell.'</td>';      
      //$re . =  $cell2;
...
function cleanString($cad)
{
	$cad= preg_replace("[^A -Za-z0-9]",'',$cad);
	$cad= str_replace('nbsp','',$cad);
	$cad = str_replace("á","a",$cad);
	$cad = str_replace("é","e",$cad);
	$cad = str_replace("í","i",$cad);
	$cad = str_replace("ó","o",$cad);
	$cad = str_replace("u","u",$cad);		
	$cad = str_replace("Á","A",$cad);
	$cad = str_replace("É","E",$cad);
	$cad = str_replace("Í","I",$cad);
	$cad = str_replace("Ó","O",$cad);
	...
	$cad = str_replace("ñ","n",$cad);
	$cad = str_replace("ª",".",$cad);	
	$cad = str_replace("º",".",$cad);	
	$cad = str_replace("Ü","U",$cad);	
	$cad = str_replace("ü","u",$cad);
	$cad = str_replace("Ø","D",$cad);
	$cad = str_replace("  "," ",$cad);
	$cad = str_replace("·","",$cad);
	$cad = str_replace('"','',$cad);	
	$cad = str_replace("'","",$cad);
	$cad = str_replace("Ø","o",$cad);
	$cad = str_replace(";",",",$cad);
	$cad = str_replace("……",".",$cad);
	$cad = str_replace("\n"," ",$cad);
	$cad = str_replace("Â","º",$cad);
