...
//	public $max_file_size = 1048576; //Max File Size in Bytes, 1MB
	public $max_file_size = 10485760; //Max File Size in Bytes, 10MB	
	...
	public $allowed_mime_types = array('application/vnd.ms-excel'); //array of allowed mime types used when check_file_type is set to allowed
